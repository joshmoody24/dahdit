...
enum MorseOptionKey {
  ...
  MORSE_OPT_AUDIO_MODE = 7,
  MORSE_OPT_WAVEFORM_TYPE = 8,
  MORSE_OPT_BACKGROUND_STATIC_LEVEL = 9,
  MORSE_OPT_CLICK_SHARPNESS = 10,
  MORSE_OPT_RESONANCE_FREQ = 11,
  MORSE_OPT_DECAY_RATE = 12,
  MORSE_OPT_MECHANICAL_NOISE = 13,
  MORSE_OPT_SOLENOID_RESPONSE = 14,
